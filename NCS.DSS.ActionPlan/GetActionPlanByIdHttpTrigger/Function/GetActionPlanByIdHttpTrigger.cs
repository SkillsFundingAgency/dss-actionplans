...
namespace NCS.DSS.ActionPlan.GetActionPlanByIdHttpTrigger.Function
{
    public class GetActionPlanByIdHttpTrigger
    {
        ...
        public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "Customers/{customerId}/Interactions/{interactionId}/ActionPlans/{actionPlanId}")] HttpRequest req, string customerId, string interactionId, string actionPlanId)
        {
            ...
            _logger.LogTrace("Attempting to get Action Plan. Customer GUID: {CustomerId}. Action Plan GUID: {ActionPlanGuid}. Correlation GUID: {CorrelationGuid}", customerGuid, actionPlanGuid, correlationGuid);
            ...
            _logger.LogTrace("Action Plan successfully retrieved. Action Plan GUID: {ActionPlanGuid}", actionPlan.ActionPlanId);
            _logger.LogTrace("Function {FunctionName} has finished invoking", nameof(GetActionPlanByIdHttpTrigger));
