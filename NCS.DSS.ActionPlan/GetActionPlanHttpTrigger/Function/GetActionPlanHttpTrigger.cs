...
namespace NCS.DSS.ActionPlan.GetActionPlanHttpTrigger.Function
{
    public class GetActionPlanHttpTrigger
    {
        ...
        {
            _logger.LogTrace("Function {FunctionName} has been invoked", nameof(GetActionPlanHttpTrigger));
            ...
            _logger.LogTrace("Attempting to get Action Plans for Customer. Customer GUID: {CustomerId}. Correlation GUID: {CorrelationGuid}", customerGuid, correlationGuid);
            ...
            {
                _logger.LogTrace("1 Action Plan successfully retrieved. Action Plan GUID: {ActionPlanGuid}", actionPlans.First().ActionPlanId);
            ...
            _logger.LogTrace("{Count} Action Plans successfully retrieved. Customer GUID: {CustomerGuid}", actionPlans.Count, customerGuid);
            _logger.LogTrace("Function {FunctionName} has finished invoking", nameof(GetActionPlanHttpTrigger));
